    ...
    for i in range(len(my_df)):
        ...
        if option_stat_mapa == 'Passes':
            if my_df['Nome_Pass_Outcome'][i] == 'Passe Certo':
                ax.plot([int(my_df["x_start"][i]), int(my_df["x_end"][i])],[int(my_df["y_start"][i]), int(my_df["y_end"][i])], color="blue", linewidth =0.3)
                ax.plot(int(my_df["x_end"][i]), int(my_df["y_end"][i]), "o", color="blue")
            if my_df['Nome_Pass_Outcome'][i] == 'Passe Errado':
                ax.plot([int(my_df["x_start"][i]), int(my_df["x_end"][i])],[int(my_df["y_start"][i]), int(my_df["y_end"][i])], color="red", linewidth =0.3)
